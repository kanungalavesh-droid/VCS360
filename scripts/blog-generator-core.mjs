// Shared logic used by both the scheduled generator (scripts/generate-blog.mjs,
// run via GitHub Actions) and the on-demand generator (netlify/functions/generate-blog.mjs,
// triggered from admin.html). Keeping this in one place means both entrypoints
...
export async function insertBlog(post, image, topic, published) {
  const db = getDb();
